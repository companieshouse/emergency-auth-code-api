...
func TestOfficerListResponse(t *testing.T) {
	Convey("Response correctly converted", t, func() {
	...
	Convey("Officer with no forename converted", t, func() {
